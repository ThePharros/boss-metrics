...
enum BossMetricsMonster
{
	...
	GROTESQUE_GUARDIANS("Grotesque Guardians", 7851, 7803, true, 6727), //7803 or 7809?
	...
	VORKATH("Vorkath", 0, 0, true, 9023),
	WINTERTODT("Wintertodt", 0, 0, false, 6462),
	ZALCANO("Zalcano", 0, 0, false, 13250),
	ZULRAH("Zulrah", 0, 0, true, 9007),
